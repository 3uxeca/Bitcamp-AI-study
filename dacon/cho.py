...
test = pd.read_csv('D:/git/Bitcamp-AI-study/dacon/test2.csv')
...
avg_submission = avg_submission.reset_index()
print(avg_submission.head())
avg_submission.to_csv('D:/git/Bitcamp-AI-study/dacon/dacon_baseline_1002.csv', index=False)