...
def build_network(keep_prob=0.5, optimizer='adam'):
    ...
    # inputs = Conv2D(Input(shape=784, kernel_size=(3,3), input_shape=(28,28,1), activation='relu', name='input'))
    x = Conv2D(784, kernel_size=(3, 3), activation='relu', name='hidden1')(inputs)
