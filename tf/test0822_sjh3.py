...
model.add(LSTM(150, input_shape=(5, 8), activation='relu', return_sequences=True))
model.add(LSTM(80, activation='relu',  kernel_regularizer = regularizers.l2(0.01), return_sequences=True))
model.add(LSTM(80, activation='relu', kernel_regularizer = regularizers.l2(0.01), return_sequences=True))
