...
# print("mnist.test.num_examples", mnist.test.num_examples) # 10000, int
# print("mnist.train.next_batch", type(mnist.train.next_batch)) # type: method
# print("mnist.test.images", mnist.test.images.shape) # x_test (10000, 784)
# print("mnist.test.labels", mnist.test.labels.shape) # y_test (10000, 10)
...
########### 이렇게도 layer를 추가할 수 있다!
L3 = tf.layers.conv2d(L2, 64, [3,3], activation=tf.nn.relu) # tf.kears.layers.conv2d도 가능(from tensorflow.keras import layers)
...
logits = tf.layers.dense(L4, 10, activation=None) # y(output) = 10
########### 이렇게도 layer를 추가할 수 있다!
